                        ...
                        if best_class_probabilities>0.53:
                            ...
                            for H_i in HumanNames:
                                if HumanNames[best_class_indices[0]] == H_i:
                                    ...
                                    print("*********************API********************")
                                    if(result_names):
                                        print("the hni customer is :" +str(result_names))
                                        print("<<<<<<<<<<<<<<<<Calling the notification services>>>>>>>>>")
                                        # Use the form modulename.itemname
                                        notification = '{  "image":"https://i.ibb.co/4jnBXjH/handshake.jpg","name":"'+ result_names +'", "message": "HNI Customer has entered!"}'
                                        service = servicelNotification.NotificationCall()
                                        service.callNotification(notification);
                                        #Call Automated API Calling
                                        toCall = '{"to":"+918638868212"}'
